...
| --- | --- | --- | --- | --- |
| `algorithm1` | RK3588 | `build.sh` | `build/algorithm1` | `mock_output.txt` |
| `algorithm2` | RK3399 | `build.sh` | `build/algorithm2` | `mock_output.txt` |
...
- `algorithm1` 接收 RK3588 的 IMU、四路视频、两份图像时间戳和两份标定路径。
